...
<div class="clause">
  ...
  <p class="sub-clause">11.3 A joint move-out inspection shall be conducted, and move-out photographs shall be recorded on the Flatvio platform as documentary evidence of the property's condition.</p>
</div>
...
<div class="clause">
  ...
  <p class="sub-clause">12.2 Move-in photographs documenting the room-wise condition of the premises have been recorded and time-stamped on the Flatvio platform and form part of this Agreement by reference.</p>
</div>
